...
/***/ "./innopacks/front/resources/js/autocomplete.js":
/*!******************************************************!*\
  !*** ./innopacks/front/resources/js/autocomplete.js ***!
  \******************************************************/
/***/ (() => {
...
/***/ "./innopacks/front/resources/js/bootstrap-validation.js":
/*!**************************************************************!*\
  !*** ./innopacks/front/resources/js/bootstrap-validation.js ***!
  \**************************************************************/
/***/ (() => {
...
/***/ "./innopacks/front/resources/js/bootstrap.js":
/*!***************************************************!*\
  !*** ./innopacks/front/resources/js/bootstrap.js ***!
  \***************************************************/
...
window.axios.defaults.headers.common['CSRF-TOKEN'] = jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[name="csrf-token"]').attr('content');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  addCart: function addCart(_ref, event, callback) {
  ...
  addWishlist: function addWishlist(id, isWishlist, event, callback) {
    if (!config.isLogin) {
      this.openLogin();
      return;
    }
    ...
    if (isWishlist) {
      ...
      axios.post("".concat(urls.favorite_cancel), {
        product_id: id
      }).then(function (res) {
        layer.msg(res.message);
      ...
      $btn.html(loadHtml).prop('disabled', true);
      axios.post("".concat(urls.favorites), {
        product_id: id
      }).then(function (res) {
        layer.msg(res.message);
  ...
  getCarts: function getCarts() {
    axios.get(urls.cart_mini).then(function (res) {
      $('.header-cart-icon .icon-quantity').text(res.data.total_format);
    });
  },
  serializedToObj: function serializedToObj(serializedStr) {
    var obj = {};
  ...
  alert: function alert() {
    ...
    var html = '';
    html += " <div id=\"alert-".concat(id, "\" class=\"alert alert-").concat(type, " alert-dismissible is-alert position-fixed me-2 z-3\">");
    html += "   <i class=\"bi ".concat(icon, "\"></i>");
    html += '   ' + msg;
  ...
  validateAndSubmitForm: function validateAndSubmitForm(form, callback) {
    $(document).on('click', "".concat(form, " .form-submit"), function (event) {
    ...
    $(document).on('keypress', "".concat(form, " input"), function (event) {
      if (event.keyCode === 13) {
        $("".concat(form, " .form-submit")).trigger('click');
      }
    });
  },
  openLogin: function openLogin() {
    ...
    layer.open({
      ...
      title: '',
      area: area,
      content: "".concat(urls.login, "?iframe=true"),
  ...
  setAppContentMinHeight: function setAppContentMinHeight() {
    var appHeaderHeight = $('#appHeader').outerHeight();
    var appFooterHeight = $('#appFooter').outerHeight(true);
...
/***/ "./innopacks/front/resources/js/footer.js":
/*!************************************************!*\
  !*** ./innopacks/front/resources/js/footer.js ***!
  \************************************************/
/***/ (() => {
...
/***/ "./innopacks/front/resources/js/header.js":
/*!************************************************!*\
  !*** ./innopacks/front/resources/js/header.js ***!
  \************************************************/
/***/ (() => {
...
$(function () {
  ...
  var headerContentHeight = $('.header-box').outerHeight(true);
  $(window).scroll(function () {
    if ($(window).scrollTop() > 0) {
      $('.header-box').addClass('active');
      if (!$('.header-content-placeholder').length && !$('body').hasClass('page-home')) $('.header-box').before('<div class="header-content-placeholder" style="height: ' + headerContentHeight + 'px;"></div>');
    } else {
...
"use strict";
/*!*********************************************!*\
  !*** ./innopacks/front/resources/js/app.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _bootstrap_validation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bootstrap-validation */ "./innopacks/front/resources/js/bootstrap-validation.js");
/* harmony import */ var _bootstrap_validation__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_bootstrap_validation__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _footer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./footer */ "./innopacks/front/resources/js/footer.js");
...
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./header */ "./innopacks/front/resources/js/header.js");
...
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./autocomplete */ "./innopacks/front/resources/js/autocomplete.js");
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_autocomplete__WEBPACK_IMPORTED_MODULE_5__);


window.inno = _common__WEBPACK_IMPORTED_MODULE_1__["default"];
...
$(function () {
  _common__WEBPACK_IMPORTED_MODULE_1__["default"].getCarts();
  ...
  $('.add-wishlist').on('click', function () {
    ...
    var isWishlist = $(this).attr('data-in-wishlist') * 1;
  ...
  _common__WEBPACK_IMPORTED_MODULE_1__["default"].setAppContentMinHeight();
  $(window).on('resize', _common__WEBPACK_IMPORTED_MODULE_1__["default"].setAppContentMinHeight);
});
})();
